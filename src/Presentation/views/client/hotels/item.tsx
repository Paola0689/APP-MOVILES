...
interface Props{
    hotel: Hotel;
    navigation: StackNavigationProp<ClientStackParamList, 'HotelDetailScreen', undefined>
}

const ClientHotelsListItem = ({hotel, navigation}: Props) => {
  
    return (
    <TouchableOpacity
    onPress={() => navigation.navigate('HotelDetailScreen', {hotel: hotel})}
    >
